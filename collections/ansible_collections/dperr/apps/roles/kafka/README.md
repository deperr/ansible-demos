# dperrone.apps kafka Role

This was taken pretty much entirely from [Zach LeBlanch's GitHub repo](https://github.com/zjleblanc/ansible-cloud-mgmt/tree/master/roles/kafka).
...
```yaml
- name: Initialize the run role from dperrone.apps
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of run role
      ansible.builtin.include_role:
        name: dperrone.apps.run
      vars:
        run_x: 42
```
